              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">الدخول!</h1>
                    <div style="font-size: 12px"> <?php check_message();?></div> 
                  </div>
                  <form class="user" method="POST" action="process.php">
                    <div class="form-group">
                      <input type="input" class="form-control form-control-user" id="user_email"  name="user_email" aria-describedby="emailHelp" placeholder="ادخل المستخدم...">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="user_pass" name="user_pass"  placeholder="كلمة المرور">
                    </div> 
